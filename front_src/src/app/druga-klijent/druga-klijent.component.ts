...
@Component({
  selector: 'app-druga-klijent',
  templateUrl: './druga-klijent.component.html',
  styleUrls: ['./druga-klijent.component.css']
})
export class DrugaKlijentComponent implements OnInit {
  ...
  deleteobj(obj){
    this.userservice.deleteobj(obj.idO, this.loggeduser).subscribe((msg:string)=>{
  ...
  izmeni(){
    if(this.cntmenjanje==null&&this.tipzamenjanje==null&&this.surfacemenjanje==null &&this.adresazamenjanje==null){
      this.msgobj="Niste odabrali nijednu stavku koju zelite da promenite";
      return;
    }
    ...
    if(this.cntmenjanje==1){ this.urlmenjanje=this.jednosobni}else if(this.cntmenjanje==2){this.urlmenjanje=this.dvosobni}else
    if(this.cntmenjanje==2){this.urlmenjanje=this.dvosobni}
  ...
  prikazi_canvas(obj){
      ...
      let c= document.getElementById("Canvasdruga") as HTMLCanvasElement;
